...
<div class="alert">
    ...
    <?php
        ...
        if (isset($_GET['error']) && $_GET['error'] === "banned") {
            echo 'user account is banned!check your email to get the reason';
        }
...
<div class="alert">
    ...
    <div class="main_container">
        <div class="container">
            <div class="left">
                <form action="login_back_end.php" method="POST" id="form">
            ...
            <div class="right">
                ...
                <p>Sign in to explore our collection and </p>
